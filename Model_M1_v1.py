...
class MyHyperModel(kt.HyperModel):
    ...
    def build(self,hp):
        ...
        learning_rate = hp.Choice("lr",[1e-5,1e-3])#hp.Float("lr", min_value=1e-5, max_value=1e-3, sampling="log")
...
## Model 1.1: Train Baseline Model
...
for tv_idx, test_idx in gss.split(data, labels, groups):
    ...
    save_model_path = save_path + "Models/model_m1_v1_fold"+str(i)+".hdf5"
...
results_filename = save_path + "Performance/model_m1_v1.mat"
