...
## Model 1.2: Train Baseline Model with Duplicate Training Data
...
for tv_idx, test_idx in gss.split(data, labels, groups):
    ...
    save_model_path = save_path + "Models/model_m1_v2_fold"+str(i)+".hdf5"
...
results_filename = save_path + "Performance/model_m1_v2.mat"
